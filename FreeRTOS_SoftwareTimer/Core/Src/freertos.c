...
void TimerPeriodicCallback(void *argument);
...
void MX_FREERTOS_Init(void) {
  ...
  TimerPeriodicHandle = osTimerNew(TimerPeriodicCallback, osTimerPeriodic, NULL, &TimerPeriodic_attributes);
...
void StartLed1Task(void *argument)
{
  /* init code for LWIP */
//  MX_LWIP_Init();
	osTimerStart(TimerPeriodicHandle, (1000 * osKernelGetTickFreq()) / 1000);
...
/* TimerPeriodicCallback function */
void TimerPeriodicCallback(void *argument)
{
  /* USER CODE BEGIN TimerPeriodicCallback */
	printf("!!!!TIMER CALLBACK!!!!\n\r");
  /* USER CODE END TimerPeriodicCallback */
}
